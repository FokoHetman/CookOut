package foko.cookout.blocks.templates;
...
public abstract class StandBlockEntity extends BlockEntity implements ImplementedInventory {
    protected DefaultedList<ItemStack> items;


    public StandBlockEntity(BlockEntityType<?> blockEntity, BlockPos pos, BlockState state, int invSize) {
